...
@Repository
@Transactional
public interface ApplicantAcademicsRepository
    extends PagingAndSortingRepository<ApplicantAcademic, Long> {

  Page<ApplicantAcademic> findAll(Pageable page);

  Page<ApplicantAcademic> findByApplicant(ApplicantWithPassword applicant, Pageable page);
