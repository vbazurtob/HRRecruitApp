...
public class Job implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    Job other = (Job) obj;
    if (datePosted == null) {
      if (other.datePosted != null) return false;
    } else if (!datePosted.equals(other.datePosted)) return false;
    if (description == null) {
    ...
    if (jobApplicants == null) {
      if (other.jobApplicants != null) return false;
    } else if (!jobApplicants.equals(other.jobApplicants)) return false;
    if (jobType == null) {
      if (other.jobType != null) return false;
    } else if (!(jobType.getId() == other.jobType.getId())) return false;
    if (salary == null) {
