...
@NamedQuery(
    name = "ApplicantWorkExperience.findAll",
    query = "SELECT a FROM ApplicantWorkExperience a")
...
public class ApplicantWorkExperience implements Serializable {
  ...
  @Id
  @SequenceGenerator(
      name = "APPLICANT_WORK_EXPERIENCE_ID_GENERATOR",
      sequenceName = "applicant_work_experience_id_seq",
      initialValue = 1,
      allocationSize = 1)
  @GeneratedValue(
      strategy = GenerationType.SEQUENCE,
      generator = "APPLICANT_WORK_EXPERIENCE_ID_GENERATOR")
  private Long id;
  ...
  public String toString() {
    return "ApplicantWorkExperience [id="
        + id
        + ", finished="
        + finished
        + ", institution="
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ApplicantWorkExperience castOther)) {
      return false;
    }
