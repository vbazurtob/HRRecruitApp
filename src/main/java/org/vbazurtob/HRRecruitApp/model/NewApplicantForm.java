...
public class NewApplicantForm {
  ...
  @Pattern(
      message =
          "Username must start with a letter. Only alphanumeric characters, the ''_'' and ''.'' characters are allowed. ''_'' or ''.'' cannot be ending characters",
  ...
  public String toString() {
    return "NewApplicantForm [password="
        + password
