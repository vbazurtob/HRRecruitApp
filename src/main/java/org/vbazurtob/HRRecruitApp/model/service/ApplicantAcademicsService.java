...
public class ApplicantAcademicsService {
  ...
  public void saveAcademicDetail(
      ApplicantAcademic applicantAcademicForm, String applicantUsername) {
  ...
  public String validateFormContent(ApplicantAcademic applicantAcademicsForm) {
    String errorFound = null;
    if (StringUtils.isEmpty(applicantAcademicsForm.getInstitution())) {
      errorFound = "Empty institution. It can't be empty.";
    } else if (StringUtils.isEmpty(applicantAcademicsForm.getDegreeName())) {
      errorFound = "Empty degree. It can't be empty.";
    } else if (applicantAcademicsForm.getStarted() == null) {
  ...
  public boolean recordExists(
    ...
    long count =
        applicantAcademicRepository
            .countByApplicantUsernameAndStartedAndFinishedAndDegreeNameAndDegreeTypeAndInstitution(
                username, started, finished, degreeName, degreeType, institution);
    return (count > 0);
  }

  public Page<ApplicantAcademic> getPaginatedRecords(
    ...
    Page<ApplicantAcademic> academicsPageObj =
        applicantAcademicRepository.findByApplicantUsername(username, pageReqObj);
