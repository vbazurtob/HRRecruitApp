...
@FormFieldsMatchConstraint.List({
  @FormFieldsMatchConstraint(
      field = "password",
      fieldMatch = "passwordConfirmation",
      message = "Passwords don''t match! No changes were made.")
})
public class ApplicantChangePasswordForm {
  ...
  @Pattern(
      message =
          "Password is too weak. It must include at least 1 number, 1 lowercase character, 1 uppercase character and 1 special character(@#$%^&+=)",
  ...
  @Valid private String usernameChangePwdForm;
  ...
  public String toString() {
    return "ApplicantChangePasswordForm [currentPassword="
        + currentPassword
        + ", password="
        + password
  ...
  public int hashCode() {
    ...
    result =
        prime * result + ((passwordConfirmation == null) ? 0 : passwordConfirmation.hashCode());
    result =
        prime * result + ((usernameChangePwdForm == null) ? 0 : usernameChangePwdForm.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (currentPassword == null) {
      if (other.currentPassword != null) return false;
    } else if (!currentPassword.equals(other.currentPassword)) return false;
    if (password == null) {
      if (other.password != null) return false;
    } else if (!password.equals(other.password)) return false;
    if (passwordConfirmation == null) {
      if (other.passwordConfirmation != null) return false;
    } else if (!passwordConfirmation.equals(other.passwordConfirmation)) return false;
