...
public interface ControllerEndpoints {
  ...
  String APPLICANT_LOGIN_URL = PUBLIC_CNTROLLER + APPLICANT_LOGIN_PAGE;
  String APPLICANT_POST_LOGIN_URL = PUBLIC_CNTROLLER + APPLICANT_LOGIN_PAGE;
  String APPLICANT_LOGOUT_URL = APPLICANT_CV_CNTROLLER + APPLICANT_LOGOUT;
  String SIGNUP_NEW_APPLICANT_URL = PUBLIC_CNTROLLER + "/signup";

  String HR_LOGIN_URL = ADMIN_CNTROLLER + HR_MEMBER_LOGIN_PAGE;
  String HR_POST_LOGIN_URL = ADMIN_CNTROLLER + HR_MEMBER_LOGIN_PAGE;
  String HR_LOGOUT_URL = JOBS_ADS_MANAGEMENT_CNTROLLER + HR_MEMBER_LOGOUT;
}
