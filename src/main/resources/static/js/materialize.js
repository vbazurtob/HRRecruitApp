...
(function ($, anim) {
  ...
  var Dropdown = (function (_Component2) {
    ...
    function Dropdown(el, options) {
      ...
      _this8._handleDocumentClickBound =
        _this8._handleDocumentClick.bind(_this8);
      _this8._handleDocumentTouchmoveBound =
        _this8._handleDocumentTouchmove.bind(_this8);
      _this8._handleDropdownKeydownBound =
        _this8._handleDropdownKeydown.bind(_this8);
      _this8._handleTriggerKeydownBound =
        _this8._handleTriggerKeydown.bind(_this8);
            ...
            setTimeout(function () {
              ...
              setTimeout(function () {
                ...
                _this50._handleDocumentClickBound =
                  _this50._handleDocumentClick.bind(_this50);
                window.addEventListener(
                  "scroll",
      ...
      [
        ...
        },
        {
          ...
          value: function destroySelects() {
            var oldYearSelect =
              this.calendarEl.querySelector(".pika-select-year");
            if (oldYearSelect) {
              M.FormSelect.getInstance(oldYearSelect).destroy();
            }
            var oldMonthSelect =
              this.calendarEl.querySelector(".pika-select-month");
            if (oldMonthSelect) {
